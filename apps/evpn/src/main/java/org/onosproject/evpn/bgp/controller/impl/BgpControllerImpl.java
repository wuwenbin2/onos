...
import org.onosproject.bgp.controller.BgpPeerService;
...
public class BgpControllerImpl implements BgpController {
     ...
     * they are.
     */
    public class BgpPeerManagerImpl implements BgpPeerService {
        ...
        public boolean isPeerConnected(BgpId bgpId) {
            if (connectedPeers.get(bgpId) == null) {
                this.log.info("Peer bgpIp {} was not connected.", bgpId.toString());
                return false;
            }
