 ...
 */
public class ResolvedNextHop implements NextHop {
     ...
     */
    public ResolvedNextHop(IpAddress ip, MacAddress mac) {
        this.ip = ip;
        this.mac = mac;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ResolvedNextHop)) {
            return false;
        }

        ResolvedNextHop that = (ResolvedNextHop) other;
